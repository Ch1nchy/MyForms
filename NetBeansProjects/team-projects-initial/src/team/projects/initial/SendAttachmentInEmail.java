...
public class SendAttachmentInEmail {
    ...
    public SendAttachmentInEmail() throws FileNotFoundException, IOException, NamingException { 
        ...
        */
        ...
        returned = mxrecords.lookupMailHosts("outlook.com");
        
        for (String returned1 : returned) {
            System.out.print(returned1 + "\r\n");
        }
        ...
        props.put("mail.smtp.host", "gmail-smtp-in.l.google.com");  //"smtp.gmail.com"
